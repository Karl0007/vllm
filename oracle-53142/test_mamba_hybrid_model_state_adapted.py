...
def test_add_request_seeds_state_idx_in_mamba_blocks() -> None:
    """ADAPTED (cache_config carries mamba_block_size, as in production).
    ...
    # ADAPTED: __init__ is bypassed, so seed the lazy-binding attributes that
    # #55507's variant initializes there.
